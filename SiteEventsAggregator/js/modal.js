...
function initModal() {
    ...
    registerLink?.addEventListener("click", e => { e.preventDefault(); openModal("register"); });
    closeModal?.addEventListener("click", closeAuthModal);
    authModal?.addEventListener("click", e => { if (e.target === authModal) closeAuthModal(); });

    toRegister?.addEventListener("click", e => { e.preventDefault(); switchTab("register"); });
    toLoginFromReg?.addEventListener("click", e => { e.preventDefault(); switchTab("login"); });
    forgotLink?.addEventListener("click", e => { e.preventDefault(); switchTab("reset"); });
    toRegisterFromReset?.addEventListener("click", e => { e.preventDefault(); switchTab("register"); });
    toLoginFromReset?.addEventListener("click", e => { e.preventDefault(); switchTab("login"); });
